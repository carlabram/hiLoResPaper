...
\title[More is not better]{You do not need high-resolution spectra to model galaxy growth}
...
As such, we suggest that future surveys aimed at supporting SFH reconstruction opt for 
wavelength coverage over spectral resolution in their designs.

Section \ref{sec:data} describes the data. Section \ref{sec:results} compares 
the spectral predictions to the high resolution data. Section \ref{sec:upshot} presents our key results. 
Section \ref{sec:discussion} discusses their implications. We use AB magnitudes and assume 
...
\subsection{tex filler}

needed to put some stuff here because for some reason my compiler breaks without it
