...
sampled datasets. That is, absorption line details---{\it at least once convolved by a galaxy's velocity 
dispersion}---are sufficiently correlated to stellar continua on large scales that capturing the details 
of the latter across a large enough wavelength range yields the same information more cheaply than 
